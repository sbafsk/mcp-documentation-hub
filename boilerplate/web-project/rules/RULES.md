# RULES.md – Development Standards for [Project Name]
...
Use [Your API Choice] API layer over [Your Backend] for querying data.
...
Document public components and [Your API Choice] schemas.
